<template v-if="this.info === true">
    <div class="user-menu">
        <div class="col-md-3 mx-auto">
            <div class="card" style="width: 30rem;">
                <div class="card-body" id="cardInfo" v-if="this.info == true">
                ...
                <div class="card-body" id="cardInfo" v-else>
                    <form @submit.prevent :model="userFormInput" class="form-input">
